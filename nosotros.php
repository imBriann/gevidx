...
<body>
    <nav class="barra-nav">
        ...
        <div class="nav-links">
            ...
            <a href="#" class="seleccion">Nosotros</a>
    ...
    <div class="card2">
        <section id="inicio" class="nosotrosInicio">
            <div class="gevidx">
                <img src="recursos/img/logo-animado.gif" alt="">
                <div class="gContenedor">
                    <h2>GeVidx</h2>
                    <p>GeVidx es una plataforma diseñada para proporcionar información clara y concisa sobre las herramientas tecnológicas más relevantes para la comunidad educativa de la Universidad de Pamplona, facilitando su comprensión y uso.</p>
                </div>
            </div>
            <div class="mision">
                <div class="gMision">
                    <h2>Misión</h2>
                    <p>Fomentar el acceso al conocimiento tecnológico dentro de la Universidad de Pamplona mediante una plataforma accesible y didáctica, promoviendo el aprendizaje y la integración digital en el entorno educativo.</p>
                </div>
                <img src="recursos/img/mision.jpg" alt="">
            </div>
            <div class="vision">
                <img src="recursos/img/vision.jpg" alt="">
                <div class="gVision">
                    <h2>Visión</h2>
                    <p>Convertirnos en un referente de consulta tecnológica en el ámbito universitario, apoyando la transformación digital y contribuyendo al desarrollo académico mediante recursos innovadores y actualizados.</p>
                </div>
            </div>
        </section>
    </div>
        ...
        <div class="GeBr">
            <div class="infoPer">
                <div class="card3">
                    ...
                    <h2>Brian<br /><span>Acevedo</span></h2>
                    <p>
                        <svg
                            class="icon"
            ...
            <div class="infoPer">
                <div class="card3">
                    <div class="blob2"></div>
                    <span class="img2"></span>
                    <h2>Geron<br /><span>Vergara</span></h2>
                    <p>
                        <svg
                            class="icon"
                            viewBox="0 0 1024 1024"
