...
<body>
    ...
    <section id="inicio" style="margin-top: 50px;">
    ...
    <section id="nosotros">
        <div class="about-container">
            <div class="about-image">
                <img src="recursos/img/unipamplona2.jpg" alt="Imagen" class="responsive-img">
            </div>
    ...
    <section id="temas" class="temas2">
        ...
        <div class="temas" style="margin-top: -20px;">
            <div class="contenedor">
                ...
                <img src="recursos/img/OStp.jpg" alt="Sistemas Operativos">
            </div>
            <div class="contenedor">
                <div class="card">
                    <div class="bg">
                ...
                <img src="recursos/img/GPtp.jpg" alt="Gestion de Procesos">
            </div>
            <div class="contenedor">
                <div class="card">
                    <div class="bg">
                ...
                <img src="recursos/img/JMtp.jpg" alt="Jerarquia de Memoria">
            </div>
    ...
    <div id="contacto" class="contacto">
        <div class="formulario">
            <h2>Envia tu PQRS</h2>
            <p>¿Tienes alguna petición, queja, reclamo o solicitud?
                Ingresa al siguiente enlace y déjanos tu mensaje: <a href="PQRS.php">PQRS</a></p>
        </div>
        <div class="ubicacion">
            <img src="recursos/img/mUP.png" alt="">
